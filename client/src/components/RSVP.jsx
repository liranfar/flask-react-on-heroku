            ...
            <div className="container">
                <div className="row align-items-center justify-content-center">
                    <div className="col-md-8 col-md-offset-2">
                        {!(props.isRsvpSent) && <form onSubmit={(event) => props.handleRsvp(event)} id="form-rsvp">
                            <div className="row">
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="form-group">
                                        <label htmlFor="rsvp-greeting" className="text-medium">Greeting:</label>
                                        <textarea
                                            name="greeting"
                                            id="rsvp-greeting"
                                            className="font-alt form-control"
                                            rows="6"
                                            placeholder="Will be shown in the greetings list"
                        ...
                        {props.isRsvpSent && <div>
                            <h3>See you soon, Thanks! </h3>
                            <h4> Gili & Matan </h4>
                        </div>
                        }
                    </div>
